...
var Board = exports.Board = function (_EventEmitter) {
    ...
    function Board(client) {
        ...
        _this._client.on('message', function (topic, message) {
    ...
    _createClass(Board, [{
        ...
        value: function genMessageId() {
            Board._MESSAGE_ID = ++Board._MESSAGE_ID;
            Board._MESSAGE_ID = Board._MESSAGE_ID > MAX_MESSAGE_ID ? 0 : Board._MESSAGE_ID;

            return Board._MESSAGE_ID;
        }
        ...
        value: function await(topic, cb) {
            ...
            this.once(topic, function (message) {
                _this2.client.unsubscribe(topic, function (err) {
                    if (err) throw err;
                });
        ...
        value: function digitalRead(pin) {
            ...
            if (this._status == CONNECTED) {
                this.client.publish('digitalRead', pin + '|' + id);
                this.await(id, cb);
                d.resolve(LOW);
            } else {
                setTimeout(function () {
